...
export const Jobs = () => {
  ...
  for (let i = startButton; i <= endButton; i++) {
    pageButtons.push(
      <button
        ...
        className={`mx-1 px-3 py-1 border border-gray-700 rounded ${currentPage === i ? 'bg-gradient-to-r from-indigo-900 to-purple-900  text-white' : 'bg-gradient-to-r from-indigo-900 to-purple-900  text-white hover:bg-gray-800 hover:text-white'}`}
      >
        {i}
      </button>
    );
  ...
  return (
    <>
      <MetaData title="Jobs" />
      <div className='bg-gradient-to-r from-rose-900 to-amber-900 min-h-screen pt-14 sm:px-20 px-3  text-white'>
                    ...
                    <div className='flex  flex-col'>
                      ...
                      <div className="flex justify-center mt-1">
                        <button
                          ...
                          className="bg-amber-900 border border-gray-700 hover:bg-amber-800 text-white font-bold py-2 px-4 mr-2"
                        >
                          Previous
                        </button>
                        ...
                        <button
                          ...
                          className="bg-amber-900 border border-amber-700 hover:bg-amber-800 text-white font-bold py-2 px-4 ml-2"
                        >
                          Next
                        </button>
                      </div>
