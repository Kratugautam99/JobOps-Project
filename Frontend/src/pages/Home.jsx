...
export const Home = () => {
    ...
    return (
        ...
        <>
            <MetaData title="JobOps" />
            <div className='min-h-screen md:px-20 px-3  pt-14 flex   text-white bg-blue-950'>
                <div className='  w-full  flex  pt-28 flex-col justify-start  items-center gap-4'>
                    ...
                    <div className='flex md:flex-row flex-col items-center justify-center md:gap-10 gap-1'>
                        <div className='md:text-8xl text-6xl titleT'>JOBOps</div>
                        <div className=' flex justify-center items-center pt-1'>
                            <Link to="/jobs" className='bg-rose-700 font-semibold md:text-2xl text-lg text-white md:py-3 py-2 px-6 md:px-10 hover:bg-indigo-800 transition duration-300 '>Browse Jobs</Link>
                        </div>
                    </div>
                    <div>
                                    ...
                                    <div>
                                        <div className='flex md:flex-row flex-col gap-3'>
                                            ...
                                            {allJobs && allJobs.length >= 4 ? (
                                               <>
                                                 <Link to={`/details/${allJobs[3]._id}`} className='flex gap-2 shadow-sm shadow-gray-800 border border-gray-700 md:w-[26rem] w-[21rem] p-2 flex-col bg-slate-900 hover:border-rose-500 transition duration-300 hover:scale-[1.02] hover:bg-rose-950'>
                                                 ...
                                                 <Link  to={`/details/${allJobs[5]._id}`} className='flex gap-2 shadow-sm shadow-gray-800 border border-gray-700 md:w-[26rem] w-[21rem] p-2 flex-col bg-slate-900 hover:border-rose-500 transition duration-300 hover:scale-[1.02] hover:bg-rose-950'>
                                                    <div className='flex gap-3 '>
                                                        <div className='w-[5rem]  flex justify-center items-center' >
                                                 ...
                                                 <Link  to={`/details/${allJobs[2]._id}`} className='flex gap-2 shadow-sm shadow-gray-800 border border-gray-700 md:w-[26rem] w-[21rem] p-2 flex-col bg-slate-900 hover:border-rose-500 transition duration-300 hover:scale-[1.02] hover:bg-rose-950'>
                                                    <div className='flex gap-3'>
                                                        <div className='w-[5rem]  flex justify-center items-center' >
                    ...
                    <div className="pt-[7rem] pb-[10rem] md:px-[14rem] px-[1rem]   text-center">
                        <p>Discover the Power of Possibility with JobOps: Where Your Professional Journey Takes Flight, Guided by a Network of Diverse Opportunities!</p>
                    </div>
