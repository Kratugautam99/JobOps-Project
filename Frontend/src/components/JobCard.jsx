...
export const JobCard = ({ job }) => {
    ...
    return (
        <>
            ...
            <Link to={`/details/${job._id}`} className='bg-zinc-500 text-white flex flex-col gap-2  shadow-sm shadow-gray-800 border border-gray-700 md:px-4 px-3 w-full py-2'>
